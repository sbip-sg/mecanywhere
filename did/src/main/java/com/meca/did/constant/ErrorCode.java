...
public enum ErrorCode {
     ...
     */
    CREDENTIAL_ERROR(100400, "error occurred during processing credential tasks"),
    ...
    CREDENTIAL_ISSUER_MISMATCH(100403,
            "issuer (signer) DID does not match the DID of credential"),
     ...
     */
    CREDENTIAL_ISSUER_INVALID(100418, "credential issuer invalid or mismatch the DID auth"),
    ...
    /**
     * Authorization DIDs: from and to must be different.
     */
    AUTHORIZATION_FROM_TO_MUST_BE_DIFFERENT(100450,
            "authorization's fromDID and toDID must be different"
    ),

    /**
     * Authorization: cannot authorize other DID's resource.
     */
    AUTHORIZATION_CANNOT_AUTHORIZE_OTHER_DID_RESOURCE(100451,
            "cannot authorize other DID's resource"
    ),
    ...
    /**
     * the authority of the ID is invalid.
     */
     ...
     */
    DID_CANNOT_REMOVE_ITS_OWN_PUB_KEY_WITHOUT_BACKUP(
            100111,
            "cannot remove this DID's owner or last public key without an available backup."
    ),

    /**
     * DID pubkey already exists, used in add case.
     */
    DID_PUBLIC_KEY_ALREADY_EXISTS(
            100116,
            "this public key already exists and is not revoked."
    ),

    /**
     * DID pubkey does not exist, used in revoke case.
     */
    DID_PUBLIC_KEY_NOT_EXIST(
            100117,
     ...
     */
    DID_PUBLIC_KEY_LENGTH_INVALID(
            100118,
            "the input public key length is invalid, the key length should be 64 bytes."
    ),

    /**
     * public key prefix is invalid.
     */
    DID_PUBLIC_KEY_PREFIX_INVALID(
            100119,
            "the input public key prefix is invalid, the first byte must not start with 0x04."
    ),
    ...
    /**
     * data type case exceptions or error.
     */
