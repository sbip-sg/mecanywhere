...
import com.meca.did.protocol.inf.RawSerializer;
...
@Data
public class Challenge implements RawSerializer {
     ...
     * @return Challenge
     */
    public static Challenge fromJson(String challengeJson) throws DataTypeCastException {
