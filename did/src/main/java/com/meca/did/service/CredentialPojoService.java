...
public interface CredentialPojoService {
     ...
     */
    ResponseData<Boolean> verifyCredential(String issuerDID, CredentialPojo credential);

    /**
     * Verify the validity of a presentation wrapping a credential.
     *
     * @param presentation the presentation
     * @return the verification result. True if yes, false otherwise with exact verify error codes
     */
    ResponseData<Boolean> verifyPresentation(PresentationPojo presentation);
}
