    ...
    credential: dict = Field(
        ...
        example={
            "credential": {
                ...
                "proof": {
                    "creator": "did:meca:0x52c328ef8b382b1d71cc262b868d803a137ab8d8",
                    "salt": {
                        "gender": "ZZijO",
                        "name": "6fLwp",
                        "DID": "cXQ86",
                ...
                "signatureThumbprint": '{"claim":{"DID":"did:meca:0x0fa21fd3d11d2cd5e6cdef2c7cd6531a25a5964f","age":29,"gender":"M","name":"Chai"},"context":"https://www.w3.org/2018/credentials/v1","cptId":2000000,"expirationDate":4833658078,"id":"234508ed-fc5b-4ea4-88ac-f04bc657f470","issuanceDate":1680058078,"issuer":"did:meca:0x52c328ef8b382b1d71cc262b868d803a137ab8d8","type":["VerifiableCredential","original"]}',
                "salt": {
                    "gender": "ZZijO",
                    "name": "6fLwp",
                    "DID": "cXQ86",
