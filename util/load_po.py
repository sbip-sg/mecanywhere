...
did_response = requests.post(f'http://{verifier_url}/api/v1/did/create', headers={'Content-Type': 'application/json'}, json=did_input)
print("DID creation response:", did_response.json())
print()
cpt_response = requests.post(f'http://{issuer_url}/api/v1/cpt/register', headers={'Content-Type': 'application/json'}, json=cpt_input)
print("Schema creation response:", cpt_response.json())
print()
vc_response = requests.post(f'http://{issuer_url}/api/v1/credential/create', headers={'Content-Type': 'application/json'}, json=vc_input)
